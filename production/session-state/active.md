...
- **S2a (7/4) 구현 완료**: 전화 스케줄링 퍼즐 (Day 1 후반 업무) — 사진 클릭=수정구 통화, 끌기=캘린더 부착, 도장 확정, 위반=다음날 아침 사고 보고서. **단계 비연결 원칙** 확정 (각 단계 = 독립 지원자 세트, 랜덤 풀 대비 — mvp-design §3).
- **다음: S2b = 면접 루프** (몬스터 등장 + 질문 카드 + 답변 마킹) → S3 = 3일 구조·승진·가젯·Day 3 이중반전. 상세는 브리프 참조.
