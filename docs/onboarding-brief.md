...
- **[design/art/art-bible.md](../design/art/art-bible.md)** — ⚠️ 옛 헥사 전투 기준 문서. 승계분도 축소: **2026-08-18부터 캐릭터 = 복셀풍 로우폴리(블렌더)** — MagicaVoxel 복셀·정점색 파이프라인 폐기 (리지드 애니 원칙만 유효). 「마왕성 인사팀」은 **환경 = 로우폴리 3D**, 코지 미니어처 톤 미승계. 재작성 대기.
